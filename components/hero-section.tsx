      ...
      <main className="overflow-x-hidden">
        <section>
          <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
            <div className="relative mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">
                  Transform your Ideas into beautiful 2D animations
                </h1>
                ...
                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                  ...
                  >
                    <Link href="/chat">
                      <span className="text-nowrap">Start Manimating</span>
            ...
            {/* Video background */}
            <div className="absolute inset-0 -z-10 mt-24 overflow-hidden lg:mt-0">
              <div className="relative h-full w-full">
                <video
                  ...
                  src="https://res.cloudinary.com/drpk7ijbb/video/upload/v1746456032/n26mnhak0gamtmdybahz.mp4"
                ></video>
              </div>
            </div>
          </div>
